# surface-blue theme build on the base of azure ttk theme by rdbende

package require Tk 8.6

namespace eval ttk::theme::surface-blue {

    variable version 1.0
    package provide ttk::theme::surface-blue $version
    variable colors
    array set colors {
        -fg             "#000000"
        -bg             "#ffffff"
    ...
    LoadImages [file join [file dirname [info script]] surface-blue]

    # Settings
    ttk::style theme create surface-blue -parent default -settings {
        ttk::style configure . \
